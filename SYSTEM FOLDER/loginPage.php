...
<html lang="en">
    <head>
		...
		<style>body {
            background-image: url('mainMenu/background.jpg');
            background-size: cover;
            background-repeat: no-repeat;
        }</style
		<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
        <link href="mainMenu/css/styles.css" rel="stylesheet" />
                                    ...
                                    <div class="card-body">
                                        <form action="" method="POST">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="mainMenu/forgetPassword.php">Forgot Password?</a>
												<button class="btn btn-primary" type="submit" name="loginButton">Login</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="mainMenu/registerPage.php">Need an account? Sign up!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
	 ...
	 if(isSet($_POST['loginButton'])){
		...
		if($validUser){
			...
			if($userType=='ADMIN'){
				...
				echo "<script>window.top.location='dashboard/dashboardStaff.php'</script>";
			}else{
				echo "<script>window.top.location='Homepage/index.html'</script>";
			}
		}
		else{
